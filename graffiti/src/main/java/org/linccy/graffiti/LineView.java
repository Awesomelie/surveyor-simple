...
public class LineView extends View {
    ...
    protected  float mCurrentLineWidth = MarkPath.NORMAL_LINE_WIDTH; //この行
    protected boolean mIsDoubleTouch = false; //この行
    protected int mPathCount = 0; //この行
    protected ArrayList<MarkPath> mFinishedPaths; //この行
    protected MarkPath mCurrentPath = null; //この

    private Bitmap mBitmap = null;
    private Canvas mTempCanvas = null;
    private Paint mPaint = null;
    protected float mScale = 1; //この行
    protected PointF mOffset = new PointF(0, 0); //この行

    /**
     * 保存down下的坐标点
     */
    protected PointF mCurrentPoint; //この行

    /**
     * 当前的标记类型
     */
    protected MarkPath.MarkType mCurrentType = MarkPath.MarkType.PEN_1; //この行
    private int width;
    private int height;
