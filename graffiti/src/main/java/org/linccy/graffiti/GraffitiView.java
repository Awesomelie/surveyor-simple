...
public class GraffitiView extends RelativeLayout {
    ...
    protected static final long TO_CANVAS_TIME = ViewConfiguration.getTapTimeout();//触发绘图板onTouch的触摸时间　この行
    protected float[] mMatrixValues = new float[9]; //この行
    private float mGraffitiX, mGraffitiY;
    protected float mOldDistance; // この行
    protected boolean mIsDrag = false; // この行
    protected boolean mIsClick = false; // この行変えた！！！！！！！！！！ private → protected
    protected RelativeLayout mShowView; // この行
    private ImageView mImageView;
    protected LineView mLineView; // この行変えた！！！！！！！！！！ private → protected
    private Bitmap mCutoutImage = null;
    protected PointF mOldPointer = null; // この行
    private float initImageWidth;
    private float initImageHeight;
    private int lastHashcode = 0;
    protected OnGraffitiViewOnClickListener mOnGraffitiViewOnClick; //この行
    ...
    protected long mOnACTION_DOWN_TIME; //この行
...
//                startScale = true;
    ...
    protected float checkingScale(float scale, float scaleFactor) { //この行
    ...
    protected void checkingGraffiti() { //この行
